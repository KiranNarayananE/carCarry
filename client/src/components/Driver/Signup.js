...
const Signup = () => {
 ...
 const DriverSignup = async (Data) => {
  try {
    const response = await AxiosInstance.post(`/driver/signup`, Data, {
  ...
  return (
    <section className="w-full h-full p-6  bg-white-800 text-gray-50">
      <form
        ...
        <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-900">
          ...
          <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
            <div className="col-span-full sm:col-span-3">
              <div className="form-control w-full max-w-xs">
                <label className="label">
                  <span className="label-text text-white"> Driving Licence</span>
                </label>
                <input
                  type="text"
                  placeholder="Type here"
            ...
            <div className="form-control w-full  max-w-xs">
              <label className="label">
                <span className="label-text text-white">Charge Per Km</span>
              </label>
              <input
                type="number"
                placeholder="₹"
