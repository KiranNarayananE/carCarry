...
const PendingBookings = () => {
  ...
  return (
    <>
      <section className="text-gray-400  body-font h-screen ">
        <div className="container md:pl-28  px-5 md:py-36 py-28 mx-auto">
            ...
            <div className="flex justify-center">
              <div className="alert alert-success shadow-lg mb-4 w-96">
                <div>
                  ...
                  <span className="text-black">New booking accepted!</span>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="flex flex-col text-start w-full mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-black ">Pending Bookings</h1>
