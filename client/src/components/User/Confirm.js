    ...
    <>
      ...
      {booked && (
        <>
          ...
          <div className="modal ">
            <div className="modal-box relative h-5/6  bg-regal-blue text-white mt-14  scrollbar-hide ">
              ...
              <div className="flex-row justify-start">
                <div className="flex items-center  gap-4 ">
                  <div>
                    <label className="label">
                      <span className="label-text text-real-orange">Select Date</span>
                    </label>
                    <Datepicker className="m-5" options={options} onChange={handleChange} show={show} setShow={handleDatePicker} />
                  </div>
                  <div className="md:ml-40">
                    <label className="label">
                      <span className="label-text text-real-orange">Time</span>
                    </label>
                    <input type="time" className="input input-bordered text-black" onChange={(e) => setTripTime(e.target.value)} value={tripTime} />
                  </div>
                </div>
                <div className="md:flex ">
                <div className="form-control mt-2">
                  <label className="label">
                    <span className="label-text text-real-orange">Pickup</span>
                  </label>
                  <label className="input-group">
                  <input type="text" disabled value={driver ? tripDetails.pickup : "null"} className="input input-bordered text-black" />
                  
                  </label>
                </div>
                <div className="form-control mt-2 md:ml-4">
                  <label className="label">
                    <span className="label-text text-real-orange">Drop Off</span>
                  </label>
                  <label className="input-group">
                  <input type="text" disabled className="input input-bordered text-black" value={driver ? tripDetails.dropOff : "null"} />
                  </label>
                </div>
                </div>
                <div className="form-control mt-2">
                  <label className="label">
                    <span className="label-text text-real-orange">Enter amount</span>
                  </label>
                  <label className="input-group">
                  <input
                      type="text"
                ...
                <div className="relative block overflow-hidden rounded-lg  mt-5 border border-gray-100 p-8">
                  ...
                  <div className="justify-between sm:flex">
                    <div>
                      <h3 className="text-xl font-bold text-real-orange">
                        NAME:
                    ...
                    <div className="ml-3 hidden  flex-shrink-0  sm:block ">
                      <img alt="Paul Clapton" src={driver && `/images/${driver.PicturePath}`} className="h-16 w-16 rounded-lg object-cover shadow-sm bg-white" />
