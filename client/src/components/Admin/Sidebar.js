  ...
  return (
    <>
      <div className="flex justify-between items-center ">
        ...
        <h1 className="text-2xl font-semibold whitespace-nowrap text-real-orange mr-5">carCarry</h1>
      </div>
      ...
      <aside
        ...
        aria-label="Sidebar">
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-black bg-regal-blue">
          ...
          <ul className="space-y-2">
            ...
            <Link to="/admin/driver-approval">
              <li className="flex items-center p-2 mt-4 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <span className="flex-1 ml-3 whitespace-nowrap text-real-orange">Driver Approval</span>
              </li>
            </Link>
