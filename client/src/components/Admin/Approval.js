...
const Approval = () => {
  ...
  const driverApproval = async (token) => {
    try {
  ...
  //*  Driver details *//
   const driverDetails = async (id, token) => {
    try {
  ...
  return (
    <>
      ...
      {!driver ? (
        ...
        <div className="modal">
            {console.log(driver.firstName,"dri")}
          <div className="modal-box md:w-3/12  max-w-5xl">
            <div className="flex justify-items-stretch ">
              <h3 className="font-bold text-lg text-gray-400">
                First Name :<span className="text-black ml-2">{driver.firstName}</span>
              </h3>
              <h3 className="font-bold text-lg text-gray-400 ml-5">
                Last Name :<span className="text-black ml-2">{driver.lastName}</span>
              </h3>
            </div>
            <h3 className="font-bold text-lg text-gray-400 mt-6">
              Email :<span className="text-black ml-2">{driver.email}</span>
            </h3>
            <h3 className="font-bold text-lg text-gray-400 mt-6">
              Phone :<span className="text-black ml-2">{driver.phone}</span>
            </h3>
            <h3 className="font-bold text-lg text-gray-400 mt-6">
              City:<span className="text-black ml-2">{driver.city}</span>
            </h3>
            <h3 className="font-bold text-lg text-gray-400 mt-6">
              State :<span className="text-black ml-2">{driver.state}</span>
            </h3>
            <div className="flex justify-items-stretch">
              <h3 className="font-bold text-lg text-gray-400 mt-6">
                DLRNO :<span className="text-black ml-2">{driver.DLRNO}</span>
              </h3>{" "}
              <h3 className="font-bold text-lg text-gray-400 mt-6 ml-6">
                Vehicle No :<span className="text-black ml-2">{driver.vehicleNo}</span>
              </h3>
            </div>
            ...
            <div className="flex justify-center items-center">
              ...
              <div>
                <h3 className="font-bold text-lg text-gray-400 mt-6 ml-6">
                  Model :<span className="text-black ml-2">{driver.vehicleModel}</span>
                </h3>{" "}
                <h3 className="font-bold text-lg text-gray-400 mt-6 ml-6">
                  Vel No :<span className="text-black ml-2">{driver.vehicleNo}</span>
                </h3>
              </div>
            </div>
            <div className="modal-action flex justify-between">
